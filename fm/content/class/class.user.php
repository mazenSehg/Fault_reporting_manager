		...
		public function view__profile__page(){
			...
			<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
				...
				<ul class="list-unstyled user_data">
					...
					<li>
						<i class="fa fa-phone">
						</i><?php echo get_user_meta($user__id,'user_phone');?>
					</li>
					<?php endif; ?>
					<li class="m-top-xs">
						<i class="fa fa-child">
				...
				<br />
				<a class="btn btn-success btn-sm" href="<?php echo site_url();?>/edit-user/?user_id=<?php echo $user__id;?>">
				...
				<tbody>
					...
					<tr>
						<td class="text-center">
							<img src="<?php echo get_user_profile_image($single_user->ID);?>" class="avatar center-block" alt="Avatar">
						</td>
						<td>
							<?php _e($single_user->first_name.' '.$single_user->last_name);?><?php echo ' '.$admin_label;?>
						</td>
						<td>
						...
						<td class="text-center">
							<label>
								<input type="checkbox" class="js-switch" <?php checked($single_user->user_status , 1);?> onClick="javascript:approve_switch(this);" data-id="<?php echo $single_user->ID;?>" data-action="user_account_status_change"/>
							</label>
						</td>
						<?php endif; ?>
						<td class="text-center">
							<a href="<?php echo site_url();?>/view-user/?user_id=<?php echo $single_user->ID;?>" class="btn btn-success btn-xs">
								<i class="fa fa-eye">
								</i>View
							</a>
							<a href="<?php echo site_url();?>/edit-user/?user_id=<?php echo $single_user->ID;?>" class="btn btn-dark btn-xs">
								<i class="fa fa-edit">
								</i>Edit
							</a>
							<a href="#" class="btn btn-danger btn-xs" onclick="javascript:delete_function(this);" data-id="<?php echo $single_user->ID;?>" data-action="delete_user">
								<i class="fa fa-trash">
								</i>Delete
							</a>
						</td>
