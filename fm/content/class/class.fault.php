...
class Fault{
		...
		<form class="add-fault submit-form" method="post" autocomplete="off">
			...
			<div class="row">
				...
				<div class="form-group col-sm-12 col-xs-12">
					<label for="decommed">
						Show Decommed Equipment
					</label>
					<br/>
					<label>
						<input type="checkbox" class="js-switch show-decommed" />
					</label>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="form-group col-sm-12 col-xs-12">
					...
					<br/>
					<label>
						<input type="radio" class="flat" name="fault_corrected_by_user" value="1" /> Yes
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="fault_corrected_by_user" value="0" checked/> No
					</label>
				</div>
				<div class="form-group col-sm-12 col-xs-12">
					<label for="">
					...
					<br/>
					<label>
						<input type="radio" class="flat" name="to_fix_at_next_service_visit" value="1" /> Yes
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="to_fix_at_next_service_visit" value="0" checked/> No
					</label>
				</div>
				<div class="form-group col-sm-12 col-xs-12">
					<label for="">
					...
					<br/>
					<label>
						<input type="radio" class="flat" name="engineer_called_out" value="1" /> Yes
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="engineer_called_out" value="0" checked/> No
					</label>
				</div>
				<div class="form-group col-sm-12 col-xs-12">
					<label for="">
					...
					<br/>
					<label>
						<input type="radio" class="flat" name="adverse_incident_report" value="1" /> Yes
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="adverse_incident_report" value="0" checked/> No
					</label>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="form-group col-sm-12 col-xs-12">
					...
					<br/>
					<label>
						<input type="radio" class="flat" name="satisfied_servicing_organisation" value="1" /> Yes
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="satisfied_servicing_organisation" value="0" /> No
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="satisfied_servicing_organisation" value="2" checked/> N/A
					</label>
				</div>
				<div class="form-group col-sm-12 col-xs-12">
					<label for="">
					...
					<br/>
					<label>
						<input type="radio" class="flat" name="satisfied_service_engineer" value="1" /> Yes
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="satisfied_service_engineer" value="0" /> No
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="satisfied_service_engineer" value="2" checked/> N/A
					</label>
				</div>
				<div class="form-group col-sm-12 col-xs-12">
					<label for="">
					...
					<br/>
					<label>
						<input type="radio" class="flat" name="satisfied_equipment" value="1" /> Yes
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="satisfied_equipment" value="0" /> No
					</label>
					<label>
						&nbsp;
					</label>
					<label>
						<input type="radio" class="flat" name="satisfied_equipment" value="2" checked/> N/A
					</label>
				</div>
			</div>
			<div class="ln_solid">
		...
		<form class="edit-fault submit-form" method="post" autocomplete="off">
			...
			<div class="row">
				...
				<div class="form-group col-sm-6 col-xs-12">
					...
					<select name="equipment" class="form-control select_single require select-equipment fetch-service-agent-data" tabindex="-1" data-placeholder="Choose equipment">
						<?php
						$data = get_tabledata(TBL_EQUIPMENTS,false,array('centre'=> $fault->centre ,'approved' => '1'), 'ORDER BY `name` ASC');
						$option_data = get_option_data($data,array('ID','name'));
	...
	public function fetch__centre__equipment__data__process(){
		...
		$data = '';
		$data = get_tabledata(TBL_EQUIPMENTS,false,array('centre'=> $id , 'decommed' => $decommed , 'approved' => '1'), 'ORDER BY `name` ASC');
		$option_data = get_option_data($data,array('ID','name'));
	...
	public function fetch__equipment__data__process(){
		...
		if($id != ''):
			/*$data = '';
			$data = get_tabledata(TBL_EQUIPMENTS, false, array('equipment_type'=> $id ,'decommed' => $decommed ,'approved' => '1') , 'ORDER BY `name` ASC');
			$option_data = get_option_data($data,array('ID','name'));
			$return['equipment_html'] = get_options_list($option_data);*/
